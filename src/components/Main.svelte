...
<main class="flex flex-col flex-1 p-4">
    ...
    >
        ...
        >
            ...
            <p class="text-base sm:text-lg md:text-xl">
                ...
                (NEXT.JS or SvelteKit), TailwindCSS, React.js, Node.js + Express.js, Django (Python), Wordpress,
                MySQL, PostgreSQL, MongoDB, Firebase, and more.
            </p>
            <button
        ...
        <div class="relative shadow-2xl grid place-items-center">
            <img
                src={"img/facemob.png"}
                alt="Profile Pic"
                class="object-cover z-[2] max-h-[50vh] shadow-lg duration-200 group-hover:opacity-100 group-hover:shadow-xl"    
            />
        </div>
    ...
    <section class="py-20 lg:py-32 flex flex-col gap-24" id="projects">
        ...
        <a
            href="https://www.youtube.com/@Zealworthy/featured"
            target="_blank"
